...
export default function NewsletterForm() {
    ...
    return (
      ...
      <NetlifyFormProvider {...netlify} className="form-container">
        <NetlifyFormComponent className="form" onSubmit={handleSubmit(onSubmit)}>
          <Honeypot />
          {netlify.success && (
          ...
          <div className="input-container">
            <label className="form-icon" htmlFor='name' sx={{ variant: 'forms.label' }}>
            <FaUserAlt />
            </label>
            <input
            className="input"
              ...
              {...register("Full Name", {required: "Full Name is required", maxLength: 80})}
              sx={{
                variant: 'forms.input'
              }}
            />
          ...
          <div className="input-container">
            <label className="form-icon" htmlFor='email' sx={{ variant: 'forms.label' }}>
            <FaEnvelope />
            </label>
            <input
            className="input"
              ...
              {...register("Email", {required: "Email is required", pattern: EMAIL_REGEX})}
              sx={{
                variant: 'forms.input'
              }}
            />
          ...
          <div className="input-container">
            <label className="form-icon" htmlFor='message' sx={{ variant: 'forms.label' }}>
            <FaCommentDots/>
            </label>
            <textarea rows="10"
                className="input"
              ...
              id='message'
              placeholder="Message"
              {...register("Message", {required: "Please enter your concern"})}
              sx={{
                variant: 'forms.input'
              }}
            />
          ...
          <div sx={{ pt: 3 }} className="btn-container">
            <button type='submit' className="send-btn" sx={{ variant: 'buttons.success' }}>
